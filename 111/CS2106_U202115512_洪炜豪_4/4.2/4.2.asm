...
printMID proto
stringcmp proto :byte, :byte ,:byte
...
outer2:
    ...
    mov eax, 0
    mov ecx, 0
    invoke stringcmp,username, value1,flag
    invoke stringcmp,password, value2,flag
	cmp flag,1
    jz Pass
wrong:
   inc count
...
stringcmp proc truevalue:byte, input:byte,  flag1:byte		
